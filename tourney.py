...
if __name__ == '__main__':
    ...
    bullet = Config(engine_1_path=new, engine_2_path=old, time_control=1 * 60, increment=1, total_games=n_bullet) # 1 + 0
    blitz = Config(engine_1_path=new, engine_2_path=old, time_control=3 * 60, increment=1, total_games=n_blitz) # 3 + 1
    rapid = Config(engine_1_path=new, engine_2_path=old, time_control=10 * 60, increment=0, total_games=n_rapid) # 10 + 1
